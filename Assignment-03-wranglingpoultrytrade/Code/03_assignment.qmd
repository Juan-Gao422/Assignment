...
PoultryDataClean <- PoultryData %>% 
  ...
  dplyr::select( # Keep columns with meaning variation, excluding those that are constant or duplicated in other columns
    ref_year,
    flow_desc, 
    partner_desc, 
    classification_code, 
...
TopfiveCountry_2018 <- PoultryDataClean_Import %>%
...
TopfiveCountry_2024 <- PoultryDataClean_Import %>%
...
TotalImportValue_Year <- PoultryDataClean_Import %>%
